    ...
    <div className="container  mt-5" >
      <div className="row mt-5" >
        ...
        <div className="col">
          ...
          <a href="" className="a ">Upcoming IPOs </a>
          <br />
          <a href="" className="a ">Brokerage charges</a>
          <br />
          <a href="" className="a ">Market holidays</a>
          <br />
          <a href="" className="a ">Economic calendar</a>
          <br />
          <a href="" className="a " >Calculators</a>
          <br />
          <a href="" className="a ">Markets</a>
          <br />
          <a href="" className="a ">Sectors</a>
        </div>
      </div>
