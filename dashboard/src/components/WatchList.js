    ...
    <div className="watchlist-container">
      <div className="search-container">
        <input
          ...
          name="search"
          id="search"
          placeholder="Search eg:infy,bse,infty fut weekly, gold mcx"
          className="search"
        />

        <span className="count">{watchlist.lenght} / 50</span>
      </div>
      <ul className="list">
...
const WatchListIteam = ({ stock }) => {
  ...
  return (
    <li onMouseEnter={handleMouserEnter} onMouseLeave={handleMouserLeave}>
      <div className="item">
